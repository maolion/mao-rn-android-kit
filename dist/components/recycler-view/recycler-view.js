...
let RecyclerView = class RecyclerView extends Component {
    ...
    handleScroll(event) {
        if (global.__DEV__) {
            if (this.props.onScroll && !this.props.scrollEventThrottle) {
                console.log('You specified `onScroll` on a <RecyclerViewAndroid> but not ' +
    ...
    render() {
        ...
        return (React.createElement(RCTRecyclerView, __assign({}, this.props, eventProps, {style: [styles.base, this.props.style], onScroll: this.handleScroll.bind(this), ref: (component) => this._scrollView = component, onRefreshStart: onRefreshStart ? (() => {
...
RecyclerView.propTypes = Object.assign({}, ScrollView.propTypes, {
    showVerticalScrollIndicator: PropTypes.bool
});
RecyclerView = __decorate([
    reactMixins([ScrollResponder.Mixin])
], RecyclerView);
const RCTRecyclerView = requireNativeComponent('MaoKitsRecyclerViewAndroid', RecyclerView, {
    nativeOnly: {}
});
